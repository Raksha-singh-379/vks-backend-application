...
import { EntityArrayResponseType, LoanDisbursementDetailsService } from '../service/loan-disbursement-details.service';
...
@Component({
  selector: 'jhi-loan-disbursement-details',
...
export class LoanDisbursementDetailsComponent implements OnInit {
  ...
  trackId = (_index: number, item: ILoanDisbursementDetails): number =>
    this.loanDisbursementDetailsService.getLoanDisbursementDetailsIdentifier(item);

  ngOnInit(): void {
    this.load();
  }

  delete(loanDisbursementDetails: ILoanDisbursementDetails): void {
    const modalRef = this.modalService.open(LoanDisbursementDetailsDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.loanDisbursementDetails = loanDisbursementDetails;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.loanDisbursementDetails = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ILoanDisbursementDetails[] | null): ILoanDisbursementDetails[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.loanDisbursementDetailsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
