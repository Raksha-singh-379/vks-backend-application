...
type MemberLandAssetsFormGroupContent = {
  ...
  freeField1: FormControl<MemberLandAssetsFormRawValue['freeField1']>;
  freeField2: FormControl<MemberLandAssetsFormRawValue['freeField2']>;
  freeField3: FormControl<MemberLandAssetsFormRawValue['freeField3']>;
  member: FormControl<MemberLandAssetsFormRawValue['member']>;
};
...
export class MemberLandAssetsFormService {
  createMemberLandAssetsFormGroup(memberLandAssets: MemberLandAssetsFormGroupInput = { id: null }): MemberLandAssetsFormGroup {
    ...
    return new FormGroup<MemberLandAssetsFormGroupContent>({
      ...
      freeField1: new FormControl(memberLandAssetsRawValue.freeField1),
      freeField2: new FormControl(memberLandAssetsRawValue.freeField2),
      freeField3: new FormControl(memberLandAssetsRawValue.freeField3),
      member: new FormControl(memberLandAssetsRawValue.member),
    });
  }
