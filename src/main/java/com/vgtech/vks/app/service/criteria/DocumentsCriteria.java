...
/**
 * Criteria class for the {@link com.vgtech.vks.app.domain.Documents} entity. This class is used
 * in {@link com.vgtech.vks.app.web.rest.DocumentsResource} to receive all the possible filtering options from
...
public class DocumentsCriteria implements Serializable, Criteria {
    ...
    private DocumentTypeFilter type;
    ...
    public DocumentTypeFilter getType() {
        return type;
    }

    public DocumentTypeFilter type() {
        if (type == null) {
            type = new DocumentTypeFilter();
        }
        return type;
    }

    public void setType(DocumentTypeFilter type) {
        this.type = type;
    }
