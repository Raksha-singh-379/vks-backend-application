...
/**
 * Criteria class for the {@link com.vgtech.vks.app.domain.SocietyNpaSetting} entity. This class is used
 * in {@link com.vgtech.vks.app.web.rest.SocietyNpaSettingResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /society-npa-settings?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class SocietyNpaSettingCriteria implements Serializable, Criteria {
    ...
    private DoubleFilter provision;
    ...
    public SocietyNpaSettingCriteria() {}

    public SocietyNpaSettingCriteria(SocietyNpaSettingCriteria other) {
    ...
    @Override
    public SocietyNpaSettingCriteria copy() {
        return new SocietyNpaSettingCriteria(this);
    }
    ...
    public DoubleFilter getProvision() {
        return provision;
    }

    public DoubleFilter provision() {
        if (provision == null) {
            provision = new DoubleFilter();
        }
        return provision;
    }

    public void setProvision(DoubleFilter provision) {
    ...
    public boolean equals(Object o) {
        ...
        final SocietyNpaSettingCriteria that = (SocietyNpaSettingCriteria) o;
        return (
    ...
    public String toString() {
        return "SocietyNpaSettingCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
