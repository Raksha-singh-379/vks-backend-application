...
/**
 * Criteria class for the {@link com.vgtech.vks.app.domain.VouchersHistory} entity. This class is used
 * in {@link com.vgtech.vks.app.web.rest.VouchersHistoryResource} to receive all the possible filtering options from
...
public class VouchersHistoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, createdOn, createdBy, voucherDate, code, freeField1, freeField2, freeField3, distinct);
    }
