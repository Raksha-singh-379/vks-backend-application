...
import com.vgtech.vks.app.repository.VoucherDetailsRepository;
import com.vgtech.vks.app.service.VoucherDetailsQueryService;
import com.vgtech.vks.app.service.VoucherDetailsService;
import com.vgtech.vks.app.service.criteria.VoucherDetailsCriteria;
...
/**
 * REST controller for managing {@link com.vgtech.vks.app.domain.VoucherDetails}.
 */
@RestController
@RequestMapping("/api")
public class VoucherDetailsResource {
    ...
    public ResponseEntity<List<VoucherDetailsDTO>> getAllVoucherDetails(
        ...
        log.debug("REST request to get VoucherDetails by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countVoucherDetails(VoucherDetailsCriteria criteria) {
        log.debug("REST request to count VoucherDetails by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
