...
import com.vgtech.vks.app.service.LoanRepaymentDetailsQueryService;
import com.vgtech.vks.app.service.LoanRepaymentDetailsService;
...
/**
 * REST controller for managing {@link com.vgtech.vks.app.domain.LoanRepaymentDetails}.
 */
@RestController
@RequestMapping("/api")
public class LoanRepaymentDetailsResource {
    ...
    public ResponseEntity<List<LoanRepaymentDetailsDTO>> getAllLoanRepaymentDetails(
        ...
        log.debug("REST request to get LoanRepaymentDetails by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countLoanRepaymentDetails(LoanRepaymentDetailsCriteria criteria) {
        log.debug("REST request to count LoanRepaymentDetails by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
