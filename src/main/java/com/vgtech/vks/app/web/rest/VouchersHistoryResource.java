...
import com.vgtech.vks.app.repository.VouchersHistoryRepository;
import com.vgtech.vks.app.service.VouchersHistoryQueryService;
import com.vgtech.vks.app.service.VouchersHistoryService;
import com.vgtech.vks.app.service.criteria.VouchersHistoryCriteria;
...
/**
 * REST controller for managing {@link com.vgtech.vks.app.domain.VouchersHistory}.
 */
@RestController
@RequestMapping("/api")
public class VouchersHistoryResource {
    ...
    public ResponseEntity<List<VouchersHistoryDTO>> getAllVouchersHistories(
        ...
        log.debug("REST request to get VouchersHistories by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countVouchersHistories(VouchersHistoryCriteria criteria) {
        log.debug("REST request to count VouchersHistories by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
