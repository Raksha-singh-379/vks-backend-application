...
import com.vgtech.vks.app.repository.VouchersRepository;
import com.vgtech.vks.app.service.VouchersQueryService;
import com.vgtech.vks.app.service.VouchersService;
import com.vgtech.vks.app.service.criteria.VouchersCriteria;
...
/**
 * REST controller for managing {@link com.vgtech.vks.app.domain.Vouchers}.
 */
@RestController
@RequestMapping("/api")
public class VouchersResource {
    ...
    public ResponseEntity<List<VouchersDTO>> getAllVouchers(
        ...
        log.debug("REST request to get Vouchers by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countVouchers(VouchersCriteria criteria) {
        log.debug("REST request to count Vouchers by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
