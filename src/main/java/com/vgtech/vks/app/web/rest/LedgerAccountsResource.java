...
import com.vgtech.vks.app.service.LedgerAccountsQueryService;
import com.vgtech.vks.app.service.LedgerAccountsService;
...
/**
 * REST controller for managing {@link com.vgtech.vks.app.domain.LedgerAccounts}.
 */
@RestController
@RequestMapping("/api")
public class LedgerAccountsResource {
    ...
    public ResponseEntity<List<LedgerAccountsDTO>> getAllLedgerAccounts(
        ...
        log.debug("REST request to get LedgerAccounts by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countLedgerAccounts(LedgerAccountsCriteria criteria) {
        log.debug("REST request to count LedgerAccounts by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
