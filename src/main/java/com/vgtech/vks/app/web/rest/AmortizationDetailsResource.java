...
import com.vgtech.vks.app.service.AmortizationDetailsQueryService;
import com.vgtech.vks.app.service.AmortizationDetailsService;
...
/**
 * REST controller for managing {@link com.vgtech.vks.app.domain.AmortizationDetails}.
 */
@RestController
@RequestMapping("/api")
public class AmortizationDetailsResource {
    ...
    public ResponseEntity<List<AmortizationDetailsDTO>> getAllAmortizationDetails(
        ...
        log.debug("REST request to get AmortizationDetails by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countAmortizationDetails(AmortizationDetailsCriteria criteria) {
        log.debug("REST request to count AmortizationDetails by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
