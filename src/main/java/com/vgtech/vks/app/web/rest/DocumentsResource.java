...
import com.vgtech.vks.app.service.DocumentsQueryService;
import com.vgtech.vks.app.service.DocumentsService;
...
/**
 * REST controller for managing {@link com.vgtech.vks.app.domain.Documents}.
 */
@RestController
@RequestMapping("/api")
public class DocumentsResource {
    ...
    public ResponseEntity<List<DocumentsDTO>> getAllDocuments(
        ...
        log.debug("REST request to get Documents by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countDocuments(DocumentsCriteria criteria) {
        log.debug("REST request to count Documents by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
