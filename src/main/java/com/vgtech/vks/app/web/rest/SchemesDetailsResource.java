...
import com.vgtech.vks.app.service.SchemesDetailsQueryService;
import com.vgtech.vks.app.service.SchemesDetailsService;
...
/**
 * REST controller for managing {@link com.vgtech.vks.app.domain.SchemesDetails}.
 */
@RestController
@RequestMapping("/api")
public class SchemesDetailsResource {
    ...
    public ResponseEntity<List<SchemesDetailsDTO>> getAllSchemesDetails(
        ...
        log.debug("REST request to get SchemesDetails by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countSchemesDetails(SchemesDetailsCriteria criteria) {
        log.debug("REST request to count SchemesDetails by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
