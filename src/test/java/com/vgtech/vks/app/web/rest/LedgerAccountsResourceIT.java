...
import com.vgtech.vks.app.repository.LedgerAccountsRepository;
import com.vgtech.vks.app.service.criteria.LedgerAccountsCriteria;
import com.vgtech.vks.app.service.dto.LedgerAccountsDTO;
import com.vgtech.vks.app.service.mapper.LedgerAccountsMapper;
...
class LedgerAccountsResourceIT {
    ...
    void createLedgerAccounts() throws Exception {
        ...
        assertThat(testLedgerAccounts.getCategory()).isEqualTo(DEFAULT_CATEGORY);
    ...
    @Test
    @Transactional
    void getAllLedgerAccountsByCategoryIsEqualToSomething() throws Exception {
        // Initialize the database
        ledgerAccountsRepository.saveAndFlush(ledgerAccounts);

        // Get all the ledgerAccountsList where category equals to DEFAULT_CATEGORY
        defaultLedgerAccountsShouldBeFound("category.equals=" + DEFAULT_CATEGORY);

        // Get all the ledgerAccountsList where category equals to UPDATED_CATEGORY
        defaultLedgerAccountsShouldNotBeFound("category.equals=" + UPDATED_CATEGORY);
    }

    @Test
    @Transactional
    void getAllLedgerAccountsByCategoryIsInShouldWork() throws Exception {
        // Initialize the database
        ledgerAccountsRepository.saveAndFlush(ledgerAccounts);

        // Get all the ledgerAccountsList where category in DEFAULT_CATEGORY or UPDATED_CATEGORY
        defaultLedgerAccountsShouldBeFound("category.in=" + DEFAULT_CATEGORY + "," + UPDATED_CATEGORY);

        // Get all the ledgerAccountsList where category equals to UPDATED_CATEGORY
        defaultLedgerAccountsShouldNotBeFound("category.in=" + UPDATED_CATEGORY);
    }

    @Test
    @Transactional
    void getAllLedgerAccountsByCategoryIsNullOrNotNull() throws Exception {
        // Initialize the database
        ledgerAccountsRepository.saveAndFlush(ledgerAccounts);

        // Get all the ledgerAccountsList where category is not null
        defaultLedgerAccountsShouldBeFound("category.specified=true");

        // Get all the ledgerAccountsList where category is null
        defaultLedgerAccountsShouldNotBeFound("category.specified=false");
    }

    @Test
    @Transactional
    void getAllLedgerAccountsByCategoryContainsSomething() throws Exception {
        // Initialize the database
        ledgerAccountsRepository.saveAndFlush(ledgerAccounts);

        // Get all the ledgerAccountsList where category contains DEFAULT_CATEGORY
        defaultLedgerAccountsShouldBeFound("category.contains=" + DEFAULT_CATEGORY);

        // Get all the ledgerAccountsList where category contains UPDATED_CATEGORY
        defaultLedgerAccountsShouldNotBeFound("category.contains=" + UPDATED_CATEGORY);
    }

    @Test
    @Transactional
    void getAllLedgerAccountsByCategoryNotContainsSomething() throws Exception {
        // Initialize the database
        ledgerAccountsRepository.saveAndFlush(ledgerAccounts);

        // Get all the ledgerAccountsList where category does not contain DEFAULT_CATEGORY
        defaultLedgerAccountsShouldNotBeFound("category.doesNotContain=" + DEFAULT_CATEGORY);

        // Get all the ledgerAccountsList where category does not contain UPDATED_CATEGORY
        defaultLedgerAccountsShouldBeFound("category.doesNotContain=" + UPDATED_CATEGORY);
    }
    ...
    @Test
    @Transactional
    void getAllLedgerAccountsBySocietyIsEqualToSomething() throws Exception {
        Society society;
        ...
        em.persist(society);
        em.flush();
        ledgerAccounts.setSociety(society);
        ledgerAccountsRepository.saveAndFlush(ledgerAccounts);
        Long societyId = society.getId();

        // Get all the ledgerAccountsList where society equals to societyId
        defaultLedgerAccountsShouldBeFound("societyId.equals=" + societyId);

        // Get all the ledgerAccountsList where society equals to (societyId + 1)
        defaultLedgerAccountsShouldNotBeFound("societyId.equals=" + (societyId + 1));
    }
    ...
    @Test
    @Transactional
    void putNewLedgerAccounts() throws Exception {
        // Initialize the database
        ledgerAccountsRepository.saveAndFlush(ledgerAccounts);
        ...
        assertThat(testLedgerAccounts.getCategory()).isEqualTo(UPDATED_CATEGORY);
