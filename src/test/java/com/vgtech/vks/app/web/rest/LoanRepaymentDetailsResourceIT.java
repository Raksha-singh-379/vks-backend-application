...
import com.vgtech.vks.app.repository.LoanRepaymentDetailsRepository;
import com.vgtech.vks.app.service.criteria.LoanRepaymentDetailsCriteria;
import com.vgtech.vks.app.service.dto.LoanRepaymentDetailsDTO;
import com.vgtech.vks.app.service.mapper.LoanRepaymentDetailsMapper;
...
class LoanRepaymentDetailsResourceIT {
    ...
    @Test
    @Transactional
    void getAllLoanRepaymentDetailsByLoanDetailsIsEqualToSomething() throws Exception {
        ...
        em.flush();
        loanRepaymentDetails.setLoanDetails(loanDetails);
        loanRepaymentDetailsRepository.saveAndFlush(loanRepaymentDetails);
        Long loanDetailsId = loanDetails.getId();

        // Get all the loanRepaymentDetailsList where loanDetails equals to loanDetailsId
        defaultLoanRepaymentDetailsShouldBeFound("loanDetailsId.equals=" + loanDetailsId);

        // Get all the loanRepaymentDetailsList where loanDetails equals to (loanDetailsId + 1)
        defaultLoanRepaymentDetailsShouldNotBeFound("loanDetailsId.equals=" + (loanDetailsId + 1));
    }
    ...
    @Test
    @Transactional
    void putNewLoanRepaymentDetails() throws Exception {
        // Initialize the database
        loanRepaymentDetailsRepository.saveAndFlush(loanRepaymentDetails);
