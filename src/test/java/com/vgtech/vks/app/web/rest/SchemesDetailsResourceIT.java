...
import com.vgtech.vks.app.repository.SchemesDetailsRepository;
import com.vgtech.vks.app.service.criteria.SchemesDetailsCriteria;
import com.vgtech.vks.app.service.dto.SchemesDetailsDTO;
import com.vgtech.vks.app.service.mapper.SchemesDetailsMapper;
...
class SchemesDetailsResourceIT {
    ...
    @Test
    @Transactional
    void getAllSchemesDetailsBySocietyIsEqualToSomething() throws Exception {
        Society society;
        ...
        em.persist(society);
        em.flush();
        schemesDetails.setSociety(society);
        schemesDetailsRepository.saveAndFlush(schemesDetails);
        Long societyId = society.getId();

        // Get all the schemesDetailsList where society equals to societyId
        defaultSchemesDetailsShouldBeFound("societyId.equals=" + societyId);

        // Get all the schemesDetailsList where society equals to (societyId + 1)
        defaultSchemesDetailsShouldNotBeFound("societyId.equals=" + (societyId + 1));
    }
    ...
    @Test
    @Transactional
    void putNewSchemesDetails() throws Exception {
        // Initialize the database
        schemesDetailsRepository.saveAndFlush(schemesDetails);
