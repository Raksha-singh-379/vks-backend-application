...
import com.vgtech.vks.app.repository.AmortizationDetailsRepository;
import com.vgtech.vks.app.service.criteria.AmortizationDetailsCriteria;
import com.vgtech.vks.app.service.dto.AmortizationDetailsDTO;
import com.vgtech.vks.app.service.mapper.AmortizationDetailsMapper;
...
class AmortizationDetailsResourceIT {
    ...
    @Test
    @Transactional
    void getAllAmortizationDetailsByLoanDetailsIsEqualToSomething() throws Exception {
        ...
        em.flush();
        amortizationDetails.setLoanDetails(loanDetails);
        amortizationDetailsRepository.saveAndFlush(amortizationDetails);
        Long loanDetailsId = loanDetails.getId();

        // Get all the amortizationDetailsList where loanDetails equals to loanDetailsId
        defaultAmortizationDetailsShouldBeFound("loanDetailsId.equals=" + loanDetailsId);

        // Get all the amortizationDetailsList where loanDetails equals to (loanDetailsId + 1)
        defaultAmortizationDetailsShouldNotBeFound("loanDetailsId.equals=" + (loanDetailsId + 1));
    }
    ...
    @Test
    @Transactional
    void putNewAmortizationDetails() throws Exception {
        // Initialize the database
        amortizationDetailsRepository.saveAndFlush(amortizationDetails);
